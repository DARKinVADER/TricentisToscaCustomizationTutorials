...
namespace ImplementingTable.Html.Adapter
{
    ...
    public class DivRowAdapter : AbstractHtmlDomNodeAdapter<IHtmlDivTechnical>, ITableRowAdapter
    {
        ...
        public DivRowAdapter(IHtmlDivTechnical technical, Validator validator) : base(technical, validator)
        {
            validator.AssertTrue(() => technical.ClassName == "div-table-caption" || technical.ClassName == "div-table-row");
        }
        #endregion
    }
}
