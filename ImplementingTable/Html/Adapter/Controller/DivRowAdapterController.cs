...
namespace ImplementingTable.Html.Adapter.Controller
{
    ...
    public class DivRowAdapterController : TableRowContextAdapterController<DivRowAdapter>
    {
        ...
        public DivRowAdapterController(DivRowAdapter contextAdapter, ISearchQuery query, Validator validator) : base(contextAdapter, query, validator)
        {
        }
