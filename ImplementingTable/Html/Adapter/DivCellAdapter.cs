...
namespace ImplementingTable.Html.Adapter
{
    ...
    public class DivCellAdapter : AbstractHtmlDomNodeAdapter<IHtmlDivTechnical>, ITableCellAdapter
    {
        ...
        public DivCellAdapter(IHtmlDivTechnical technical, Validator validator) : base(technical, validator)
        {
